...
### Latest bounded Hero/Souvenirs detail crops — 2026-08-29

The current desktop detail pass adds two small, non-documentary
`reference-derived` crops. Both remain bounded to their live decoration slots;
semantic text and responsive fallbacks stay in React/CSS.
...
Souvenirs crop uses the registered warm-line color projection to remove paper
while retaining the rosette and ring. Neither asset is documentary venue
evidence or a full reference screen.
